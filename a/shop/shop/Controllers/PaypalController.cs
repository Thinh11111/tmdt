...
+
                    ...
                    //guid we are generating for storing the paymentID received in 
                    //session
                    //after calling the create function and it is used in the payment 
                    //execution
                    ...
                    //get links returned from paypal in response to Create function 
                    //call
                    ...
                    while (links.MoveNext())
                    {
                        ...
                        {
                            //saving the payapalredirect URL to which user will be 
                ...
                {
                    // This section is executed when we have received all the payments 
                    //parameters
